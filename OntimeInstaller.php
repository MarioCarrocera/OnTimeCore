...
$files= array('OnTime.php','OnTimetmp.php','OnTimeCoreA.php','OnTimeCoreB.php','OTicore.php','OnTimeFunctions.php','OnTimeContent.php','OnTimeCripto.php','OnTimeDebug.php','OnTimeValid.php','OnTimeAllways.php');
$base = 'ontime';
if(!file_exists($base)){
	if(mkdir($base,0777)){
